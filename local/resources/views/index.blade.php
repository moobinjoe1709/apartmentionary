        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-2">
                <div class="stats-area overflow-hidden">
                    ...
                    <span data-type="bar"
                        data-sparkline="true">3,4,3,7,12,9,9,5,8,8,8,12,14,20,16,14,20,12,10,14,8,4,4,5</span>
                            ...
                            <li>
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="comment">Lorem ipsum dolor sit amet, vel fugit abhorreant ei...
                                        </div>
                            ...
                            <li>
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="comment">Duo enim harum moderatius et, sed ex oblique persius
                                            labor...</div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="input-group m-b-15">
                        <input type="text" placeholder="Please add to-do item..."
                            class="input input-sm form-control js-input">
